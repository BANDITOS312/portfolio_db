...
skills = [ (_,) for _ in (['Python', 'SQL', 'API', 'Telegram', 'HTML', 'CSS'])]
statuses = [ (_,) for _ in (['На этапе проектирования', 'В процессе разработки', 'Разработан', 'Обновлен', 'Завершен', 'Не поддерживается'])]
...
if __name__ == '__main__':
    ...
    manager.insert_project(data=[(0, "бот_автоответчик", "global.com", 1)])